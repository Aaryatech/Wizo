...
/**
 * Created by jarvis on 14/3/19.
 */

public class SchedulerFanAdapter extends BaseAdapter {
    ...
    public SchedulerFanAdapter(Context context, List<RespScheduler> list, Activity activity) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        holder.tvSpeed.setText("S-"+schPojo.getOperation());
       ...
       /* if (schPojo.getDay() == 0) {
        ...
        try {
            ...
            if (daysArray.size() > 0) {
                ...
                Log.e("DAYS STR SUB STR","----------------------------- "+daysStr.substring(0,1));
            ...
            public boolean onLongClick(View view) {
                ...
                btnUpdate.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.putExtra("devType", schPojo.getDevType());
        ...
        call.enqueue(new Callback<JsonObject>() {
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                ...
                try {
                    ...
                    if (!error) {
                        context.startActivity(new Intent(context, FanSchedulerActivity.class));
                        activity.finish();
                    } else {
                        Toast.makeText(activity, "Something went wrong, Please try again...", Toast.LENGTH_SHORT).show();
