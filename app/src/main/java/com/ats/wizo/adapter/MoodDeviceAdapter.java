...
public class MoodDeviceAdapter extends ArrayAdapter<MoodDevice> {
    ...
    public MoodDeviceAdapter(Context context, List<MoodDevice> data, Activity activity) {
                ...
                holder.tvCaption.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(list.get(i).isSelected()){
                            ...
                            AddNewMoodActivity.selectedDeviceList.remove(list.get(i));
                            ...
                            AddNewMoodActivity.selectedDeviceList.add(list.get(i));
