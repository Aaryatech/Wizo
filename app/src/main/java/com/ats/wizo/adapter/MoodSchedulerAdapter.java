...
import com.ats.wizo.activity.MoodSchedulerActivity;
...
public class MoodSchedulerAdapter extends BaseAdapter {

    LayoutInflater inflater;
    List<RespMoodScheduler> list;
    ...
    public MoodSchedulerAdapter(Context context, List<RespMoodScheduler> list, Activity activity) {
    ...
    public MoodSchedulerAdapter(Context context, List<RespMoodScheduler> list, Activity activity, String moodName) {
        inflater = LayoutInflater.from(context);
        this.activity = activity;
        this.context = context;
        this.list = list;
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        final RespMoodScheduler schPojo = list.get(i);

        Log.e("Mood Sch Adpt ", "------------*************--------------------- " + list.get(i));
            ...
            public boolean onLongClick(View view) {
                ...
                btnUpdate.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.putExtra("moodId", list.get(i).getMoodId());
                        intent.putExtra("dimmerDevType", 0);
    ...
    private void updateScheStatus(RespMoodScheduler schPojo, final int status) {
        ...
        Log.e("Mood Sch Adpt -"," --------------------------- UPDATE SCH STATUS --------------------------- "+schPojo);

        Call<RespMoodScheduleData> call = Constants.myInterface.addNewMoodScheduler(schPojo);
        call.enqueue(new Callback<RespMoodScheduleData>() {
            ...
            public void onResponse(Call<RespMoodScheduleData> call, Response<RespMoodScheduleData> response) {
                ...
                try {
                    ...
                    RespMoodScheduleData data = response.body();
    ...
    private void deleteMoodScheduler(final RespMoodScheduler schPojo) {
        ...
        Call<JsonObject> call = Constants.myInterface.deleteMoodScheduler(schPojo);
        call.enqueue(new Callback<JsonObject>() {
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                ...
                try {
                    ...
                    if (!error) {
                        Intent intent = new Intent(context, MoodSchedulerActivity.class);
                        intent.putExtra("moodId", schPojo.getMoodId());
